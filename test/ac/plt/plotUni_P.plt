...
plot "CS_Rload_P.lis" u 1:(log10($2)*20) t "|H_{BSIM}(s)|" w l ls 1 axis x1y1,\
     "uniAmp_P_ac0.csv" u 1:(log10($10)*20) t "|H_{EKV}(s)|" w l ls 2 axis x1y1,\
     "CS_Rload_P.lis" u 1:3 t "{/Symbol=16 \320}H_{BSIM}(s)" w l ls 4 axis x1y2,\
     "uniAmp_P_ac0.csv" u 1:11 t "{/Symbol=16 \320}H_{EKV}(s)" w l ls 5 axis x1y2,\
